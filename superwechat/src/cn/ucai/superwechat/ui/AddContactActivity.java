...
public class AddContactActivity extends BaseActivity {
    @BindView(R.id.ll_no_finde)
    RelativeLayout mLlNoFinde;
    private EditText editText;
    private RelativeLayout searchedUserLayout;
    private RelativeLayout findeNoUserLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findeNoUserLayout = (RelativeLayout) findViewById(R.id.ll_no_finde);
    ...
    private void serchAddName(String name) {
        NetDao.getUserInfoByName(this, name, new OnCompleteListener<String>() {
            @Override
            public void onSuccess(String s) {
                progressDialog.dismiss();
                boolean isSuccess = false;
                searchedUserLayout.setVisibility(View.GONE);
                mLlNoFinde.setVisibility(View.GONE);
                if (s != null) {
                ...
                if (!isSuccess) {
                    mLlNoFinde.setVisibility(View.VISIBLE);
                }
            }
