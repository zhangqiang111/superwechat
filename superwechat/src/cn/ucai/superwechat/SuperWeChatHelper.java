...
public class SuperWeChatHelper {
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = cn.ucai.superwechat.SuperWeChatHelper.getInstance().getContactList();
...
//        inviteMessgeDao.saveMessage(msg);
    ...
    private void saveInviteMsg(final InviteMessage msg) {
        NetDao.getUserInfoByName(appContext, username, new OnCompleteListener<String>() {
            @Override
                ...
                if (s != null) {
                    ...
                    if (result != null) {
                        if (result.isRetMsg()) {
                            ...
                            if (user != null) {
                                msg.setMuserNick(user.getMUserNick());
                                msg.setMavatarSuffix(user.getMAvatarSuffix());
                                msg.setMavatarLastUpdateTime(user.getMAvatarLastUpdateTime());
                            }
